    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-300 shadow-lg border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-8">
        ...
        >
          ...
          {/* Results */}
          {query && (
            <div className="absolute top-14 left-0 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl max-h-80 overflow-y-auto z-50">
              {results.length === 0 ? (
                ...
                results.map((item, index) => (
                  <div
                    ...
                    className={`px-4 py-3 cursor-pointer border-b border-gray-100 dark:border-gray-700 last:border-b-0 ${index === activeIndex
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs px-2 py-1 rounded-full bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400 capitalize">
                        {item.type}
                      </span>
                    </div>
                  </div>
        ...
        <nav className="hidden md:flex xl:hidden items-center gap-4">
          ...
          <Link to="/transportation" className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" title="Transportation">
            <Navigation size={18} className="text-gray-600 dark:text-gray-300 hover:text-orange-600 dark:hover:text-orange-400" />
          </Link>
        </nav>
